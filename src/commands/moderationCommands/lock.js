module.exports = {
    ...
    async execute(Yui, message, args) {
        ...
        if (previousOverwrites.json.sendMessages === false) {
            message.channel.createMessage('this channel is already locked');
            return
        }
        channel.editPermission(message.channel.guild.id, previousOverwrites.allow & ~2048n, previousOverwrites.deny | 2048n, 'role', reason)
