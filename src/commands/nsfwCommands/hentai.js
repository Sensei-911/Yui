...
module.exports = {
name: 'hentai',
description: 'Sends random hentai pictures.',
...
message.channel.send({embed: { title: 'Here, take some hentai.', color: 'RED', image: { url: hentai.url }, footer: { text: `Requested by ${message.author.tag}`}, timestamp: new Date()}})
}}