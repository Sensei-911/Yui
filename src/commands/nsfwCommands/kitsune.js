...
module.exports = {
name: 'kitsune',
description: 'Sends random kitsune pictures.',
...
message.channel.send({embed: { title: 'Here, take some kitsune.', color: 'RED', image: { url: kitsune.url }, footer: { text: `Requested by ${message.author.tag}`}, timestamp: new Date()}})
}}