...
await db.updatePrefix(message.guildID, prefix)
message.channel.createMessage({ embed: { description: `Prefix successfully changed to \`${await db.getPrefix(message.guildID)}\``, color: 0x66ff00 }})
}}