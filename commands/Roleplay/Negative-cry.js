...
const crymessage = args.slice(1).join(' ')
        
if (!user) {
let cry_embed = new Discord.MessageEmbed()
.setDescription(`**${message.author.username}** is crying`)
.setColor('RED')
.setImage(image)
message.channel.send(cry_embed);
return
}
if (crymessage.length > 0) {
let cry_embed = new Discord.MessageEmbed()
.setDescription(`**${message.author.username}** is crying at **<@!${user.id}>**\n\"${crymessage}\"`)
.setColor('RED')
.setImage(image)
message.channel.send(cry_embed);
return
...
let cry_embed = new Discord.MessageEmbed()
.setDescription(`**${message.author.username}** is crying at **me** :C`)
.setColor('RED')
.setImage(image)
message.channel.send(cry_embed);
return
...
let cry_embed = new Discord.MessageEmbed()
.setDescription(`**${message.author.username}** crying ?`)
.setColor('RED')
.setImage(image)
message.channel.send(cry_embed);
return
