...
3. Third create a sound cloud client id **(optional)** [Guide](https://github.com/zackradisic/node-soundcloud-downloader#client-id "Click!")
4. Fourth Node.js v12.0.0 or newer
5. Fifth Mongodb connection url
